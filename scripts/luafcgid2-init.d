...
# Default-Stop:      0 1 6
# Short-Description: luafcgid2
# Description:       luafcgid2 daemon
### END INIT INFO

# Author: SaltwaterC <saltwaterc@gmail.com>

# Do NOT "set -e"

# PATH should only include /usr/* if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="luafcgid2 daemon"
NAME=luafcgid2
DAEMON=/usr/bin/$NAME
DAEMON_ARGS="/etc/luafcgid2/config.lua"
